...
public class XSurviveZombifiedPiglinAttackGoal<T extends LivingEntity> extends NearestAttackableTargetGoal<T> {

	public XSurviveZombifiedPiglinAttackGoal(ZombifiedPiglin zombifiedPiglin, Class<T> targetType, boolean mustSee, boolean mustReach) {
