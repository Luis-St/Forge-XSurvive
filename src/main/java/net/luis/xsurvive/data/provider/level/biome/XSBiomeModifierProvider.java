...
/*		context.register(XSBiomeModifiers.Keys.ADD_TO_BADLANDS, createAddToBadlands(biomeRegistry, featureRegistry));
	...
	private static AddFeaturesBiomeModifier createAddToOverworld(HolderGetter<Biome> biomeRegistry, HolderGetter<PlacedFeature> featureRegistry) {
		HolderSet<PlacedFeature> features = HolderSet.direct(featureRegistry.getOrThrow(XSOrePlacements.COAL_ORE_UPPER), featureRegistry.getOrThrow(XSOrePlacements.COAL_ORE_LOWER),
				...
				featureRegistry.getOrThrow(XSOrePlacements.DIAMOND_ORE), featureRegistry.getOrThrow(XSOrePlacements.DIAMOND_ORE_LARGE),
				
				featureRegistry.getOrThrow(XSOrePlacements.DIAMOND_ORE_BURIED)
		);
	...
	private static RemoveFeaturesBiomeModifier createRemoveFromOverworld(HolderGetter<Biome> biomeRegistry, HolderGetter<PlacedFeature> featureRegistry) {
		HolderSet<PlacedFeature> features = HolderSet.direct(featureRegistry.getOrThrow(OrePlacements.ORE_COAL_UPPER), featureRegistry.getOrThrow(OrePlacements.ORE_COAL_LOWER),
				featureRegistry.getOrThrow(OrePlacements.ORE_IRON_UPPER), featureRegistry.getOrThrow(OrePlacements.ORE_IRON_MIDDLE),
				featureRegistry.getOrThrow(OrePlacements.ORE_IRON_SMALL), featureRegistry.getOrThrow(OrePlacements.ORE_GOLD),
				featureRegistry.getOrThrow(OrePlacements.ORE_GOLD_LOWER), featureRegistry.getOrThrow(OrePlacements.ORE_LAPIS),
				featureRegistry.getOrThrow(OrePlacements.ORE_LAPIS_BURIED), featureRegistry.getOrThrow(OrePlacements.ORE_REDSTONE),
				featureRegistry.getOrThrow(OrePlacements.ORE_REDSTONE_LOWER), featureRegistry.getOrThrow(OrePlacements.ORE_DIAMOND),
				featureRegistry.getOrThrow(OrePlacements.ORE_DIAMOND_LARGE), featureRegistry.getOrThrow(OrePlacements.ORE_DIAMOND_BURIED));
	...
	private static ReplaceBiomeModifier createReplaceEnd(HolderGetter<Biome> biomeRegistry, HolderGetter<PlacedFeature> featureRegistry) {
		...
		HolderSet<PlacedFeature> toRemove = HolderSet.direct(
				featureRegistry.getOrThrow(XOOrePlacements.ENDERITE_ORE_RARE),
				featureRegistry.getOrThrow(XOOrePlacements.ENDERITE_ORE_BURIED)
		);
	...
	private static ReplaceBiomeModifier createReplaceOverworld(HolderGetter<Biome> biomeRegistry, HolderGetter<PlacedFeature> featureRegistry) {
		HolderSet<PlacedFeature> toAdd = HolderSet.direct(
				featureRegistry.getOrThrow(XSOrePlacements.JADE_ORE_MIDDLE),
				featureRegistry.getOrThrow(XSOrePlacements.SAPHIRE_ORE),
				featureRegistry.getOrThrow(XSOrePlacements.SAPHIRE_ORE_BURIED),
				featureRegistry.getOrThrow(XSOrePlacements.LIMONITE_ORE_BURIED),
				featureRegistry.getOrThrow(XSOrePlacements.LIMONITE_ORE_DEEP_BURIED)
		);
		HolderSet<PlacedFeature> toRemove = HolderSet.direct(
				featureRegistry.getOrThrow(XOOrePlacements.JADE_ORE_MIDDLE),
				featureRegistry.getOrThrow(XOOrePlacements.SAPHIRE_ORE),
				featureRegistry.getOrThrow(XOOrePlacements.SAPHIRE_ORE_BURIED),
				featureRegistry.getOrThrow(XOOrePlacements.LIMONITE_ORE_BURIED),
				featureRegistry.getOrThrow(XOOrePlacements.LIMONITE_ORE_DEEP_BURIED)
		);
		return new ReplaceBiomeModifier(biomeRegistry.getOrThrow(BiomeTags.IS_END), toAdd, toRemove);
	}
	...
	private static ReplaceBiomeModifier createReplacePeak(HolderGetter<Biome> biomeRegistry, HolderGetter<PlacedFeature> featureRegistry) {
		HolderSet<PlacedFeature> toAdd = HolderSet.direct(
				featureRegistry.getOrThrow(XSOrePlacements.JADE_ORE_UPPER),
				featureRegistry.getOrThrow(XSOrePlacements.SAPHIRE_ORE_RARE_UPPER)
		);
		HolderSet<PlacedFeature> toRemove = HolderSet.direct(
				featureRegistry.getOrThrow(XOOrePlacements.JADE_ORE_UPPER),
				featureRegistry.getOrThrow(XOOrePlacements.SAPHIRE_ORE_RARE_UPPER)
		);
		return new ReplaceBiomeModifier(biomeRegistry.getOrThrow(BiomeTags.IS_END), toAdd, toRemove);
	}
