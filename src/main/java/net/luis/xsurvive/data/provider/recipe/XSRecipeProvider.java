...
public class XSRecipeProvider extends RecipeProvider {
	...
	protected void buildCraftingRecipes(Consumer<FinishedRecipe> consumer) {
		...
		this.groupAndUnlock(ShapelessRecipeBuilder.shapeless(XSBlocks.HONEY_MELON.get()).requires(XSItems.HONEY_MELON_SLICE.get(), 9), getGroup(XSBlocks.HONEY_MELON.get()), XSItems.HONEY_MELON_SLICE.get(),
			XSBlocks.HONEY_MELON.get()).save(consumer);
		this.groupAndUnlock(ShapelessRecipeBuilder.shapeless(XSItems.HONEY_MELON_SEEDS.get()).requires(XSItems.HONEY_MELON_SLICE.get()), getGroup(XSBlocks.HONEY_MELON.get()), XSItems.HONEY_MELON_SLICE.get(),
			XSItems.HONEY_MELON_SEEDS.get()).save(consumer);
		this.groupAndUnlock(ShapelessRecipeBuilder.shapeless(XSItems.HONEY_MELON_SLICE.get()).requires(Items.MELON_SLICE).requires(Items.HONEY_BOTTLE), getGroup(XSBlocks.HONEY_MELON.get()), Items.MELON_SLICE, Items.HONEY_BOTTLE,
